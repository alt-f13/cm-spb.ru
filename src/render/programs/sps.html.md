...
<div class="list-group list-group-root well">
  <a href="#" class="list-group-item">
    ...
    <div class="list-group">
      <a href="#" class="list-group-item">Выпускники получают <strong>среднее профессиональное образование</strong> с присвоением квалификации: <span class="badge info">слесарь по ремонту подвижного состава</span></a>
